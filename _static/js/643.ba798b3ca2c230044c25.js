"use strict";
(self["webpackChunkonline_banking"] = self["webpackChunkonline_banking"] || []).push([[643],{
...
/* harmony import */ var _timeoutManager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4071);
...
/* harmony import */ var _subscribable_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1652);
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6240);
// src/focusManager.ts
...
/* harmony import */ var _focusManager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(874);
/* harmony import */ var _onlineManager_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5971);
/* harmony import */ var _thenable_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3522);
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6240);
// src/retryer.ts
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9729);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5813);
"use client";
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@tanstack+query-core@5.90.2/node_modules/@tanstack/query-core/build/modern/focusManager.js
var focusManager = __webpack_require__(874);
// EXTERNAL MODULE: ./node_modules/.pnpm/@tanstack+query-core@5.90.2/node_modules/@tanstack/query-core/build/modern/notifyManager.js
var notifyManager = __webpack_require__(549);
// EXTERNAL MODULE: ./node_modules/.pnpm/@tanstack+query-core@5.90.2/node_modules/@tanstack/query-core/build/modern/query.js
var modern_query = __webpack_require__(9261);
// EXTERNAL MODULE: ./node_modules/.pnpm/@tanstack+query-core@5.90.2/node_modules/@tanstack/query-core/build/modern/subscribable.js
var subscribable = __webpack_require__(1652);
// EXTERNAL MODULE: ./node_modules/.pnpm/@tanstack+query-core@5.90.2/node_modules/@tanstack/query-core/build/modern/thenable.js
var thenable = __webpack_require__(3522);
// EXTERNAL MODULE: ./node_modules/.pnpm/@tanstack+query-core@5.90.2/node_modules/@tanstack/query-core/build/modern/utils.js
var utils = __webpack_require__(6240);
// EXTERNAL MODULE: ./node_modules/.pnpm/@tanstack+query-core@5.90.2/node_modules/@tanstack/query-core/build/modern/timeoutManager.js
var timeoutManager = __webpack_require__(4071);
...
var QueryCache = class extends subscribable/* Subscribable */.Q {
  constructor(config = {}) {
    super();
    this.config = config;
  ...
  build(client, options, state) {
    ...
    const queryHash = options.queryHash ?? (0,utils/* hashQueryKeyByOptions */.F$)(queryKey, options);
    let query = this.get(queryHash);
    if (!query) {
      query = new modern_query/* Query */.X({
        client,
        queryKey,
        queryHash,
  ...
  find(filters) {
    ...
    return this.getAll().find(
      (query) => (0,utils/* matchQuery */.MK)(defaultedFilters, query)
    );
  }
  findAll(filters = {}) {
    const queries = this.getAll();
    return Object.keys(filters).length > 0 ? queries.filter((query) => (0,utils/* matchQuery */.MK)(filters, query)) : queries;
  }
  notify(event) {
    notifyManager/* notifyManager */.jG.batch(() => {
      this.listeners.forEach((listener) => {
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@tanstack+query-core@5.90.2/node_modules/@tanstack/query-core/build/modern/removable.js
var removable = __webpack_require__(7324);
// EXTERNAL MODULE: ./node_modules/.pnpm/@tanstack+query-core@5.90.2/node_modules/@tanstack/query-core/build/modern/retryer.js
var retryer = __webpack_require__(1224);
;// ./node_modules/.pnpm/@tanstack+query-core@5.90.2/node_modules/@tanstack/query-core/build/modern/mutation.js
// src/mutation.ts



var Mutation = class extends removable/* Removable */.k {
  #client;
  #observers;
  #mutationCache;
  #retryer;
...
var MutationCache = class extends subscribable/* Subscribable */.Q {
  constructor(config = {}) {
    super();
    this.config = config;
  ...
  find(filters) {
    const defaultedFilters = { exact: true, ...filters };
    return this.getAll().find(
      (mutation) => (0,utils/* matchMutation */.nJ)(defaultedFilters, mutation)
    );
  }
  findAll(filters = {}) {
    return this.getAll().filter((mutation) => (0,utils/* matchMutation */.nJ)(filters, mutation));
  }
  notify(event) {
    notifyManager/* notifyManager */.jG.batch(() => {
      this.listeners.forEach((listener) => {
  ...
  resumePausedMutations() {
    ...
    return notifyManager/* notifyManager */.jG.batch(
      () => Promise.all(
        pausedMutations.map((mutation) => mutation.continue().catch(utils/* noop */.lQ))
      )
    );
  }
};
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@tanstack+query-core@5.90.2/node_modules/@tanstack/query-core/build/modern/focusManager.js
var focusManager = __webpack_require__(874);
// EXTERNAL MODULE: ./node_modules/.pnpm/@tanstack+query-core@5.90.2/node_modules/@tanstack/query-core/build/modern/onlineManager.js
var onlineManager = __webpack_require__(5971);
  ...
  return {
    onFetch: (context, query) => {
      ...
      const fetchFn = async () => {
        ...
        const queryFn = (0,utils/* ensureQueryFn */.ZM)(context.options, context.fetchOptions);
        const fetchPage = async (data, param, previous) => {
          ...
          const addTo = previous ? utils/* addToStart */.ZZ : utils/* addToEnd */.y9;
          return {
...
var QueryClient = class {
  ...
  mount() {
    ...
    this.#unsubscribeFocus = focusManager/* focusManager */.m.subscribe(async (focused) => {
      if (focused) {
        await this.resumePausedMutations();
        this.#queryCache.onFocus();
      }
    });
    this.#unsubscribeOnline = onlineManager/* onlineManager */.t.subscribe(async (online) => {
      if (online) {
        await this.resumePausedMutations();
  ...
  ensureQueryData(options) {
    ...
    if (options.revalidateIfStale && query.isStaleByTime((0,utils/* resolveStaleTime */.d2)(defaultedOptions.staleTime, query))) {
  ...
  cancelQueries(filters, cancelOptions = {}) {
    ...
    const promises = notifyManager/* notifyManager */.jG.batch(
  ...
  refetchQueries(filters, options = {}) {
    ...
    return Promise.all(promises).then(utils/* noop */.lQ);
  }
  fetchQuery(options) {
    const defaultedOptions = this.defaultQueryOptions(options);
    ...
    return query.isStaleByTime(
      (0,utils/* resolveStaleTime */.d2)(defaultedOptions.staleTime, query)
    ) ? query.fetch(defaultedOptions) : Promise.resolve(query.state.data);
  }
  prefetchQuery(options) {
    return this.fetchQuery(options).then(utils/* noop */.lQ).catch(utils/* noop */.lQ);
  }
  ...
  prefetchInfiniteQuery(options) {
    return this.fetchInfiniteQuery(options).then(utils/* noop */.lQ).catch(utils/* noop */.lQ);
  }
  ...
  setQueryDefaults(queryKey, options) {
    this.#queryDefaults.set((0,utils/* hashKey */.EN)(queryKey), {
      queryKey,
  ...
  getQueryDefaults(queryKey) {
    ...
    defaults.forEach((queryDefault) => {
      if ((0,utils/* partialMatchKey */.Cp)(queryKey, queryDefault.queryKey)) {
  ...
  setMutationDefaults(mutationKey, options) {
    this.#mutationDefaults.set((0,utils/* hashKey */.EN)(mutationKey), {
      mutationKey,
      defaultOptions: options
    });
  }
  getMutationDefaults(mutationKey) {
    ...
    const result = {};
    defaults.forEach((queryDefault) => {
      if ((0,utils/* partialMatchKey */.Cp)(mutationKey, queryDefault.mutationKey)) {
        Object.assign(result, queryDefault.defaultOptions);
      }
    });
    return result;
  ...
  defaultQueryOptions(options) {
    ...
    if (!defaultedOptions.queryHash) {
      defaultedOptions.queryHash = (0,utils/* hashQueryKeyByOptions */.F$)(
    ...
    if (defaultedOptions.queryFn === utils/* skipToken */.hT) {
...
/* harmony export */ });
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6240);
/* harmony import */ var _notifyManager_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(549);
/* harmony import */ var _retryer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1224);
/* harmony import */ var _removable_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7324);
// src/query.ts
